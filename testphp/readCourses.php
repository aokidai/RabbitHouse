...
$username = "3891466_rabbithouse";
$password = "AokiDaisuke91";
$dbname = "3891466_rabbithouse";
...
$conn = new mysqli($servername, $username, $password, $dbname);
 ...
 if($_POST['id']){
     ...
     $stmt = $conn->prepare("SELECT courseName,courseDescription,courseDuration FROM tessst WHERE id = ?");
