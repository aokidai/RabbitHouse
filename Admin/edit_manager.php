        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                if (isset($_POST["update"])) {
                    ...
                    if ($rs)
                        echo "<script>window.location.href='list_manager.php?page=$pages'</script>";
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                <td colspan="2">
                                    ...
                                    <button type="button" onClick="javascript:window.location.href='list_manager.php?page=<?=$pages?>'" class="btn btn-warning">Hủy</button>
                                </td>
                            </tr>
