                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <button type="button" class="btn btn-success" style="margin-bottom: 20px"
                                onClick="javascript:window.location.href='insert_manager.php'">Thêm quản trị
                                viên</button>
                            <button type="submit" class="btn btn-success" style="margin-bottom: 20px">Xóa quản trị
                                viên</button>
                            <input type="text" id="myInput" class="w3-input" onkeyup="myFunction()"
                                placeholder="Tìm tên quản lý..." title="Tìm kiếm quản lý">
                        </div>
