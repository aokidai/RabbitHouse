...
<body>
    ...
    <div id="wrapper">
        ...
        <form action="list_khachhang.php" method="post">
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">DANH SÁCH KHÁCH HÀNG</h1>
                            <button type="submit" class="btn btn-success" style="margin-bottom: 20px">Xóa khách
                                hàng</button>
                            <input type="text" id="myInput" class="w3-input" onkeyup="myFunction()"
                                placeholder="Tìm khách hàng..." title="Tìm kiếm khách hàng">
                        </div>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($rs)) {
                                    echo " <tr>
														<td><input type='checkbox' class='chk_box1' name='check_list[]' value='" . $row["idKhachhang"] . "'></td>
														<td>$i</td>
														<td>" . $row["tenKH"] . "</td>
														<td>" . $row["SDT"] . "</td>
														<td>" . $row["username"] . "</td>
                                ...
                                if (!empty($_POST['check_list'])) {
                                    foreach ($_POST['check_list'] as $check) {
                                        $sql9 = "delete from tblkhachhang where idKhachhang = '$check'";
