...
<body>
    <div id="wrapper">
        ...
        <form action="list_loai.php" method="post">
            <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <button type="button" class="btn btn-success" style="margin-bottom: 20px"
                                onClick="javascript:window.location.href='insert_loai.php'">Thêm loại</button>
                            <button type="submit" class="btn btn-success" style="margin-bottom: 20px">Xóa loại</button>
                            <input type="text" id="myInput" class="w3-input" onkeyup="myFunction()"
                                placeholder="Tìm tên loại món..." title="Tìm kiếm loại món">
                        </div>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody> <?php
                                    ...
                                    while ($row = mysqli_fetch_array($rs)) {
                                        echo " <tr>
														<td><input type='checkbox' class='chk_box1' name='check_list[]' value='" . $row["idLoai"] . "'></td>
														<td>$i</td>
														<td>" . $row["tenLoai"] . "</td>
                                    ...
                                    ?> <?php
                                        if (!empty($_POST['check_list'])) {
                                            foreach ($_POST['check_list'] as $check) {
                                                $sql9 = "delete from tblloai where idLoai = '$check'";
