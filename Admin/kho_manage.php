        ...
        <form action="kho_manage.php" method="post">
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">QUẢN LÝ TỒN KHO RABBIT HOUSE</h1>
                            <div style="float: left;">
                                <button type="button" class="btn btn-success" style="margin-bottom: 20px; margin-top: 8px;" onClick="javascript:window.location.href='list_kho.php?page=1'" title="Trở về danh sách hàng hóa trong kho">
                                    <-</button>
                            </div>
                            <div style="margin-bottom: 12px; float: left; margin-left: 10px;">
                                <form action="kho_manage.php" method="post">
                                    ...
                                    <select id="cmbThoiGian" name="ThoiGian">
                                        <?php
                                        include("../include/connect.inc");
                                        for ($thangTmp = 1; $thangTmp < 13; $thangTmp++) {
                                            echo "<option value=" . $thangTmp . ">" . $thangTmp . "</option>";
                                        }
                                        ?>
                                    </select>
                                    ...
                                    <span style="color: red; font-weight: bold;">Tháng tồn kho: 
                                        ...
                                        $thangChon = $_POST["ThoiGian"]; 
                                        if(!isset($thangChon)){
                                            echo "Chưa chọn";
                                        }
                                        else echo "Tháng $thangChon"?>
                                    </span>
                                </form>
                            </div>

                            <button type="button" onClick="javascript:window.location.href='kho_manage.php'" class="btn btn-success" style="margin-bottom: 20px; margin-top: 8px; float: right; background-color: aqua; color: black">Tải lại dữ liệu</button>
                        </div>
