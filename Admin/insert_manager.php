                    ...
                    <table class="table table-striped table-bordered table-hover" style="width:50%" align="center">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" name="txtUser" placeholder="Tên tài khoản quản lý"></td>
                            </tr>
                            <tr>
                            ...
                            <tr align="center">
                                <td colspan="2">
                                    ...
                                    <button type="button"
                                        onClick="javascript:window.location.href='list_manager.php?page=1'"
