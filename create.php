...
<form id="form" name="frmLogin" method="post" action="create.php">
  <table width="401" border="1" style="margin-top: 20px" >
    <tbody>
      <tr>
        <td colspan="2" align="center">Đăng kí tài khoản</td>
      </tr>
	  <tr align="center">
      ...
      <tr align="center">
        ...
        <td><input type="number" name="txtSDT" id="textfield5"></td>
      </tr>
		<tr align="center">
        <td>Địa chỉ<span style="color: red">(*)</span>:</td>
        <td><input type="text" name="txtDiaChi" id="textfield5"></td>
      </tr>
      <tr align="center">
      ...
      <tr align="center">
        ...
        <td><input type="password" name="txtrepassword" id="textfield2"></td>
      </tr>
      <tr align="center">
        <td colspan="2"><input type="button" name="button" id="button" value="Đăng nhập" onClick="checkLogin()">
