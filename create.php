...
function checkLogin() {
    ...
    if (document.frmLogin.txtSDT.value == "" || document.frmLogin.txtSDT.value.length > 10 || document.frmLogin.txtSDT
        .value.length < 9) {
        alert("Kiểm tra số điện thoại!");
        document.form.txtSDT.focus();
        return;
    }
    if (document.frmLogin.txtDiaChi.value == "") {
        alert("Nhập số địa chỉ!");
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" align="center"><span
                                        style="font-weight: bold; font-size:20px; font-family: 'Times New Roman', Times, serif;">Đăng
                                        kí tài khoản</span></td>
                            </tr>
                            <tr align="center">
                                <td>Họ tên<span style="color: red">(*)</span>:</td>
                                <td><input type="text" class="form-control" name="txtName" placeholder="Họ tên"
                                        id="textfield4"></td>
                            </tr>
                            <tr align="center">
                                <td>Số ĐT<span style="color: red">(*)</span>:</td>
                                <td><input type="number" class="form-control" name="txtSDT" id="textfield5"
                                        placeholder="090xxxxxxx"></td>
                            </tr>
                            <tr align="center">
                            ...
                            <tr align="center">
                                ...
                                <td><input type="password" class="form-control" name="txtrepassword" id="textfield2"
                                        placeholder="Nhập lại mật khẩu"></td>
                            </tr>
                            <tr align="center">
                                <td colspan="2"><input type="button" class="btn btn-primary" name="button" id="button"
                                        value="Tạo tài khoản" onClick="checkLogin()" title="Tạo tài khoản và đăng nhập">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"><a href="./forgot.php"><span style="float: right; color: red"
                                            title="Bạn có tài khoản nhưng quên mật khẩu?"><i>Quên mật
                                                khẩu?</i></span></a></td>
                            </tr>
                            <tr align="center">
                                <td colspan="2"><a href="./login.php"><span style="text-align: center; color: blue"
                                            title="Bạn đã có tài khoản và cần đăng nhập?"><i>Bạn có tài
                                                khoản?</i></span></a></td>
                            </tr>
                        </tbody>
                    </table>
