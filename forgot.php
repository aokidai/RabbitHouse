      ...
      if (isset($_POST["txtusername"])) {
        ...
        if ($flagKH == 1 && $flagNV == 0) {
          ...
          if ($flagNV == 1 && $flagKH == 0) {
            ...
            echo "<script>alert('Thông tin không chính sát!')</script>";
        }
      }
      ?>
            <center>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="2" align="center"><span
                                        style="font-weight: bold; font-size:20px; font-family: 'Times New Roman', Times, serif;">Đổi
                                        mật khẩu</span></td>
                            </tr>
                            <tr align="center">
                                <td width="136">Tài khoản:</td>
                                <td width="249"><input type="text" class="form-control" name="txtusername"
                                        id="textfield" placeholder="Tên tài khoản"></td>
                            </tr>
                            <tr align="center">
                                <td>Mật khẩu mới:</td>
                            ...
                            <tr align="center">
                                <td colspan="2"><input onClick="checkLogin()" class="btn btn-primary" type="submit"
                                        name="button" title="Đổi mật khẩu và đăng nhập" id="button"
                                        value="Đổi mật khẩu">
                                </td>
                            </tr>
                            <tr align="center">
