      ...
      <center>
        <form id="form1" name="frmLogin" method="post" action="forgot.php">
          <table class="table table-striped table-bordered table-hover" style="width:50%; margin-top: 20px">
            <tbody>
              <tr>
                <td colspan="2" align="center"><span style="font-weight: bold; font-size:20px; font-family: 'Times New Roman', Times, serif;">Đổi mật khẩu</span></td>
              </tr>
              <tr align="center">
                <td width="136">Tài khoản:</td>
                <td width="249"><input type="text" class="form-control" name="txtusername" id="textfield" placeholder="Tên tài khoản"></td>
              </tr>
              <tr align="center">
                <td>Mật khẩu mới:</td>
              ...
              <tr align="center">
                ...
                <td><input type="password" class="form-control" name="txtrepass" id="textfield3" placeholder="Nhập lại mật khẩu"></td>
              </tr>
              <tr align="center">
                <td colspan="2"><input onClick="checkLogin()" class="btn btn-primary" type="submit" name="button" title="Đổi mật khẩu và đăng nhập" id="button" value="Đổi mật khẩu">
                </td>
              </tr>
              <tr align="center">
                <td colspan="2"><a href="./create.php"><span style="text-align: center; color: blue" title="Bạn chưa có tài khoản?"><i>Bạn chưa có tài khoản?</i></span></a></td>
              </tr>
            </tbody>
          </table>
      </center>
