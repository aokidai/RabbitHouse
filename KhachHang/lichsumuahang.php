    ...
    <div id="body">
        <article>
            <section id="info" align="center">
                ...
                <div><span style="font-size: 20px; color: red">Trạng thái gia hàng được biểu diển bởi kí tự X và O. X là
                        chưa giao hàng còn O là đã giao hàng.</span></div>
                <br />
                    ...
                    <div class="table-responsive table-bordered">
                        ...
                        <div style="text-align: center;">
                            <input type="submit" class="btn btn-success" name="xoahang" value="Xóa hàng"
                                title="Nếu muốn xóa hàng ta cần chọn hàng cần xóa và nhấn nút Xóa hàng">
                        </div>
                        <script>
                        $('th').click(function() {
