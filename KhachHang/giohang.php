                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                        ...
                                        while ($row3 = mysqli_fetch_array($rs3)) {
                                            ...
                                            if ($rs5) {
                                                ...
                                                while ($row20 = mysqli_fetch_array($rs20)) {
                                                    ...
                                                    $idMon4 = $row20["idMon"];
                                                    $trangThaiGHtmp = "X";
                                                    $sql8 = "insert into tbllichsu(idKhachhang, idMon, soluong, gia, thoigian, daGH, idChitiet) values ('$idKhachhang2', '$idMon4', '$soluongtmpnew', '$thanhTien4', '$time_act', '$trangThaiGHtmp', '$idCTHD')";
                                    ...
                                    <td colspan="6" align="center">
                                        <input type="submit" class="btn btn-success" id="muahang"
                                            style="background-color: red; height: 35px;" name="muahang"
                                            title="Mua hàng và thanh toán cho nhân viên giao hàng"
                                        ...
                                        <div style="padding-top: 10px; width: 212px;">
                                            ...
                                            <script
                                                src="https://www.paypal.com/sdk/js?client-id=Acs-sQI19oaPGRrKfZdnaRtavv9DQa9aiavcQ7hKetDVc8ZLlsMObUIQNmY1ia2yUIfWswxU5vKTeKmN&enable-funding=venmo&currency=USD"
                                                ...
                                                paypal.Buttons({
                                                    ...
                                                    onApprove: function(data, actions) {
                                                        return actions.order.capture().then(function(
                                                            ...
                                                            document.getElementById("muahang")
                                                                .click();
                                                        });
                                                    },
                                    ...
                                    <th colspan="6">
                                        <center><label
                                                style="background-color: #f2f2f2; width: 150px; border-radius: 10px;"><a
                                                    href="./export_hoadon.php" target="_blank">📜 Xuất hóa
                                                    đơn</a></label></center>
                                    </th>
                                </tr>
                            </tbody>
                ...
                <div id="cont-footer-twitter" style="padding: 30px; float:left; margin-left:17%">
                    <div class="twitter-widget" style="text-align: center;">
                        <a class="twitter-timeline" style="text-align: center" ; data-height="300" data-width="800"
                            ...
                            href="https://twitter.com/aokidaisuke91">ツイートの青木大介</a>
