    ...
    <tbody>
      ...
      <tr align="center">
        ...
        <input type="reset" name="reset" id="reset" value="Làm lại"></td>
		 ...
		 <tr>
			 <td colspan="2"><a href="./forgot.php"><span style="float: right; color: red; font-size: 15px"><i>Quên mật khẩu?</i></span></a></td>
      </tr>
	<tr align="center">
			 <td colspan="2"><a href="./create.php"><span style="text-align: center; color: blue; font-size: 15px"><i>Bạn chưa có tài khoản?</i></span></a></td>
      </tr>
    </tbody>
  </table>
	<br/>
