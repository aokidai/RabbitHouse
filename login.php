...
function checkLogin() {
    if (document.frmLogin.txtUsername.value == "") {
        alert("Tài khoản hoặc mật khẩu bị tróng");
        ...
        if (mysqli_num_rows($rs) > 0) {
            ...
            if (mysqli_num_rows($rs2) > 0) {
                ...
                if ($password == "Demo@123") {
                    ...
                    if ($rs3)
                        echo "<script>window.location.href='./NhanVien/change-password.php'</script>";
            ...
            <table class="table table-striped table-bordered table-hover" style="width:50%; margin-top: 20px">
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td width="249"><input type="text" class="form-control" name="txtusername" id="textfield"
                                placeholder="Tên đăng nhập"></td>
                    </tr>
                    <tr align="center">
                        <td>Mật khẩu:</td>
                        <td><input type="password" name="txtpassword" class="form-control" id="textfield2"
                                placeholder="Mật khẩu"></td>
                    </tr>
                    <tr align="center">
                        <td colspan="2"><input type="submit" class="btn btn-primary" name="button" id="button"
                                value="Đăng nhập" onClick="checkLogin()" title="Đăng nhập">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><a href="./forgot.php"><span style="float: right; color: red; font-size: 15px"
                                    title="Bạn quên mật khẩu của mình?"><i>Quên mật khẩu?</i></span></a></td>
                    </tr>
                    <tr align="center">
                        <td colspan="2"><a href="./create.php"><span
                                    style="text-align: center; color: blue; font-size: 15px"
                                    title="Bạn chưa có tài khoản?"><i>Bạn chưa có tài khoản?</i></span></a></td>
                    </tr>
                </tbody>
            </table>
            <br />
